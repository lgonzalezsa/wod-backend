...
for i in $(seq $startrange $endrange); do username="$typename$i"; adduser $username --gecos "First Last,RoomNumber,WorkPhone,HomePhone" --disabled-password -ingroup jupyter; echo $username:hpeDEV2020 | chpasswd ; done
